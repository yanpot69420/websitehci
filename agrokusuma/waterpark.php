...
<body>
    ...
    <div class="hero">
        <div class="myslide">
          ...
          <img src="gambar/waterpark1.jpg" style="width: 100%; height: 100%;">
        </div>
    ...
    <div class="itemtitle" id="paket">
        <h1 class="title" id="package">PAKET WISATA WATERPARK</h1>
    </div>
    <div class="itemlist">
        ...
        <div class="item">
            <h3>Waterpark</h3>
            <img src="gambar/tbwaterpark.jpg" >
            <div class="info">
                <p>Ayo Petik Buah Naga</p>
                <p>Dan Makan Sepuasnya</p>
            </div>
            <div class="price">
                <h3><sup>Rp.</sup>25.000 / orang</h3>
            </div>
            <div class="btn">
                <a href="#">Order</a>
            </div>
