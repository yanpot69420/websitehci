...
<nav class="navbar navbar-expand-md" id="navbar">
    <!-- Brand -->
    <a class="navbar-brand" href="home"><img src="gambar/logox.png"></a>
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="streetview">STREET VIEW</a>
        </li>
        <li class="nav-item">
          ...
          <table class="table table-bordered table-striped text-center">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <p>Rp.</p>&nbsp;&nbsp;<?= number_format($row['product_price'],2); ?>
                </td>
                <input type="hidden" class="pprice" value="<?= $row['product_price'] ?>">
                <td>
                  <input type="number" class="form-control itemQty" value="<?= $row['qty'] ?>" style="width:75px;">
                </td>
                <td><p>Rp.</p>&nbsp;&nbsp;<?= number_format($row['total_price'],2); ?></td>
                <td>
              ...
              <tr>
                ...
                <td><b><p>Rp.</p>&nbsp;&nbsp;<?= number_format($grand_total,2); ?></b></td>
                <td>
